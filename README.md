...
| `setup-usb-storage` | Prepares USB disks, swap files, and mounts for overlay or data use, offers interactive device selection, and can install USB support packages. |
